...
# fw = FwBoost(epsi=0.01, has_dcap=True, ratio=0.1)
# fw.train(htr, y_train, codetype="cy", ftr='wl')
pd = ParaBoost(0.01, has_dcap=False, ratio=0.1)
pd.train(htr, y_train, ftr='wl')
fw2 = FwBoost(epsi=0.01, has_dcap=False, steprule=3)
fw2.train(htr, y_train, codetype="py", ftr='wl')
fw3 = FwBoost(epsi=0.01, has_dcap=False, steprule=2)
fw3.train(htr, y_train, codetype="py", ftr='wl')
