/* Generated by Cython 0.20.1 on Fri May 23 02:19:12 2014 */
 ...
 * cdef void exp_descent(np.ndarray[double, mode='c']v, np.ndarray[double, mode='c']x0,             # <<<<<<<<<<<<<<
 *                  np.ndarray[double, mode='c'] x, double sigma, dist_option=2):
 *     """
 */
struct __pyx_opt_args_3src_14frank_wolfe_cy_exp_descent {
  int __pyx_n;
...
static PyObject *__pyx_f_3src_14frank_wolfe_cy_fw_boost_cy(PyArrayObject *, double, double, int, bool, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_3src_14frank_wolfe_cy__primal_objective(PyArrayObject *, double); /*proto*/
static double __pyx_f_3src_14frank_wolfe_cy_k_average(PyArrayObject *, unsigned int); /*proto*/
static void __pyx_f_3src_14frank_wolfe_cy_proj_cap_ent(PyArrayObject *, double); /*proto*/
static void __pyx_f_3src_14frank_wolfe_cy_exp_descent(PyArrayObject *, PyArrayObject *, PyArrayObject *, double, struct __pyx_opt_args_3src_14frank_wolfe_cy_exp_descent *__pyx_optional_args); /*proto*/
static void __pyx_f_3src_14frank_wolfe_cy_mat_vec(PyArrayObject *, PyArrayObject *, PyArrayObject *); /*proto*/
static void __pyx_f_3src_14frank_wolfe_cy_vec_mat(PyArrayObject *, PyArrayObject *, PyArrayObject *); /*proto*/
static double __pyx_f_3src_14frank_wolfe_cy_smallest(PyArrayObject *); /*proto*/
...
static PyObject *__pyx_pf_3src_14frank_wolfe_cy_fw_boost_cy(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_hh, double __pyx_v_epsi, double __pyx_v_ratio, int __pyx_v_steprule, bool __pyx_v_has_dcap); /* proto */
...
/* "src/frank_wolfe_cy.pyx":23
 * @cython.boundscheck(False)
 * @cython.cdivision(True)
 * cpdef fw_boost_cy(np.ndarray[double, ndim=2, mode='fortran']hh,             # <<<<<<<<<<<<<<
 *                   double epsi, double ratio, int steprule, bool has_dcap):
 *     """
 */
...
static PyObject *__pyx_f_3src_14frank_wolfe_cy_fw_boost_cy(PyArrayObject *__pyx_v_hh, double __pyx_v_epsi, double __pyx_v_ratio, int __pyx_v_steprule, bool __pyx_v_has_dcap, CYTHON_UNUSED int __pyx_skip_dispatch) {
  unsigned int __pyx_v_n;
  unsigned int __pyx_v_p;
  std::vector<double> __pyx_v_margin;
  std::vector<double> __pyx_v_primal_obj;
  std::vector<double> __pyx_v_gap;
  ...
  __pyx_pybuffernd_hh.rcbuffer = &__pyx_pybuffer_hh;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_hh.rcbuffer->pybuffer, (PyObject*)__pyx_v_hh, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_F_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  /* "src/frank_wolfe_cy.pyx":41
 *     cdef vector[double] err_tr
 *     # alpha = np.ones(p)/p
 *     cdef double[:] alpha = np.zeros(p)             # <<<<<<<<<<<<<<
 *     d0_py = np.ones(n) / n
 *     cdef np.ndarray[double, mode='c'] d0 = d0_py
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_p); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     d0_py = np.ones(n) / n             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[double, mode='c'] d0 = d0_py
 *     cdef np.ndarray[double, mode='c'] d= np.zeros(n)
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_ones); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     cdef np.ndarray[double, mode='c'] d0 = d0_py             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[double, mode='c'] d= np.zeros(n)
 *     cdef np.ndarray[double, mode='c'] d_next = np.zeros(n)
 */
  if (!(likely(((__pyx_v_d0_py) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_d0_py, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = __pyx_v_d0_py;
  __Pyx_INCREF(__pyx_t_3);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_d0.rcbuffer->pybuffer, (PyObject*)((PyArrayObject *)__pyx_t_3), &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {
 ...
 *     cdef np.ndarray[double, mode='c'] d= np.zeros(n)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[double, mode='c'] d_next = np.zeros(n)
 *     cdef np.ndarray[double, mode='c'] dt_h = np.zeros(p)
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_d.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_d_next.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {
 ...
 *     cdef np.ndarray[double, mode='c'] dt_h = np.zeros(p)             # <<<<<<<<<<<<<<
 *     cdef double mu = epsi / (2 * math.log(n))
 *     cdef np.ndarray[double, mode='c'] h_a = np.zeros(n)
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_p); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dt_h.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {
 ...
 *     cdef double ej
 */
  __pyx_v_mu = (__pyx_v_epsi / (2.0 * log(__pyx_v_n)));

  /* "src/frank_wolfe_cy.pyx":48
 *     cdef np.ndarray[double, mode='c'] dt_h = np.zeros(p)
 *     cdef double mu = epsi / (2 * math.log(n))
 *     cdef np.ndarray[double, mode='c'] h_a = np.zeros(n)             # <<<<<<<<<<<<<<
 *     cdef double ej
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_h_a.rcbuffer->pybuffer, (PyObject*)__pyx_t_8, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 *     # h_a = np.dot(hh, alpha)
 */
  __pyx_v_max_iter = ((unsigned int)(log(__pyx_v_n) / pow(__pyx_v_epsi, 2.0)));

  /* "src/frank_wolfe_cy.pyx":52
 *     cdef double eta
 *     cdef unsigned int max_iter = int(math.log(n) / epsi**2)
 *     cdef unsigned int nu = int(n * ratio)             # <<<<<<<<<<<<<<
 *     # h_a = np.dot(hh, alpha)
 ...
 */
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_alpha, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  if (!(likely(__Pyx_TypeTest(__pyx_t_3, __pyx_ptype_5numpy_ndarray)))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_f_3src_14frank_wolfe_cy_mat_vec(((PyArrayObject *)__pyx_v_hh), ((PyArrayObject *)__pyx_t_3), ((PyArrayObject *)__pyx_v_h_a));
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "src/frank_wolfe_cy.pyx":59
 *     cdef double res, tmp
 * 
 *     print " fw-boosting: maximal iter #: "+str(max_iter)             # <<<<<<<<<<<<<<
 *     for t in range(max_iter):
 *         exp_descent(h_a, d0, d, 1 / mu)
 */
  __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_max_iter); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GIVEREF(__pyx_t_3);
  __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)(&PyString_Type))), __pyx_t_2, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyNumber_Add(__pyx_kp_s_fw_boosting_maximal_iter, __pyx_t_3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (__Pyx_PrintOne(0, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "src/frank_wolfe_cy.pyx":60
 * 
 *     print " fw-boosting: maximal iter #: "+str(max_iter)
 *     for t in range(max_iter):             # <<<<<<<<<<<<<<
 *         exp_descent(h_a, d0, d, 1 / mu)
 ...
 *         if has_dcap:
 */
    __pyx_f_3src_14frank_wolfe_cy_exp_descent(((PyArrayObject *)__pyx_v_h_a), ((PyArrayObject *)__pyx_v_d0), ((PyArrayObject *)__pyx_v_d), (1.0 / __pyx_v_mu), NULL);
 ...
 *         # d = d_
 */
    __pyx_t_11 = (__pyx_v_has_dcap != 0);
    if (__pyx_t_11) {

      /* "src/frank_wolfe_cy.pyx":64
 *         # assert not math.isnan(d_next[0])
 *         if has_dcap:
 *             proj_cap_ent(d, 1.0 / nu)             # <<<<<<<<<<<<<<
 *         # d = d_
 *         vec_mat(d, hh, dt_h)
 */
      __pyx_f_3src_14frank_wolfe_cy_proj_cap_ent(((PyArrayObject *)__pyx_v_d), (1.0 / __pyx_v_nu));
      goto __pyx_L5;
    }
    __pyx_L5:;
 ...
 *         ej = fabs(dt_h[0])
 */
    __pyx_f_3src_14frank_wolfe_cy_vec_mat(((PyArrayObject *)__pyx_v_d), ((PyArrayObject *)__pyx_v_hh), ((PyArrayObject *)__pyx_v_dt_h));
 ...
 */
    __pyx_t_12 = 0;
    if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_pybuffernd_dt_h.diminfo[0].shape;
    __pyx_v_ej = fabs((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_dt_h.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_dt_h.diminfo[0].strides)));
 ...
 */
      ...
      __pyx_t_11 = ((fabs((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_dt_h.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_dt_h.diminfo[0].strides))) > __pyx_v_ej) != 0);
      if (__pyx_t_11) {
 ...
 */
        ...
        __pyx_v_ej = fabs((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_dt_h.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_dt_h.diminfo[0].strides)));
 ...
 */
      ...
      __pyx_v_res = (__pyx_v_res - ((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_dt_h.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_dt_h.diminfo[0].strides)) * (*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_18 * __pyx_v_alpha.strides[0]) )))));
    }
 ...
 */
    ...
    __pyx_v_res = (__pyx_v_res + ((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_dt_h.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_dt_h.diminfo[0].strides)) * __pyx_v_ej));
 ...
 *         if has_dcap:
 */
    __pyx_v_gap.push_back(__pyx_v_res);
 ...
 *         else:
 */
      __pyx_v_min_margin = __pyx_f_3src_14frank_wolfe_cy_k_average(((PyArrayObject *)__pyx_v_h_a), __pyx_v_nu);
 ...
 */
      __pyx_v_margin.push_back(__pyx_v_min_margin);
      goto __pyx_L11;
    }
    /*else*/ {
 ...
 *         primal_obj.push_back(_primal_objective(h_a, mu))
 */
 ...
 *         if steprule == 1:
 */
    __pyx_v_primal_obj.push_back(__pyx_f_3src_14frank_wolfe_cy__primal_objective(((PyArrayObject *)__pyx_v_h_a), __pyx_v_mu));

    /* "src/frank_wolfe_cy.pyx":99
 *                     res += fabs(alpha[i]-ej)
 *             eta = fmax(0, fmin(1, mu * gap[-1] / res ** 2))
 *         elif steprule == 2:             # <<<<<<<<<<<<<<
 ...
 */
          ...
          __pyx_v_res = (__pyx_v_res + fabs((*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_20 * __pyx_v_alpha.strides[0]) )))));
          goto __pyx_L14;
        }
        /*else*/ {
 ...
 */
          ...
          __pyx_v_res = (__pyx_v_res + fabs(((*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_21 * __pyx_v_alpha.strides[0]) ))) - __pyx_v_ej)));
        }
        __pyx_L14:;
      }
 ...
 *             res = fabs(h_a[0] - hh[0,j] * ej)
 */
      __pyx_v_eta = fmax(0.0, fmin(1.0, ((__pyx_v_mu * (__pyx_v_gap[-1])) / pow(__pyx_v_res, 2.0))));
      break;
 ...
 */
      __pyx_t_22 = 0;
      if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_pybuffernd_h_a.diminfo[0].shape;
      __pyx_t_23 = 0;
      __pyx_t_14 = __pyx_v_j;
      if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_pybuffernd_hh.diminfo[0].shape;
      __pyx_v_res = fabs(((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_h_a.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_h_a.diminfo[0].strides)) - ((*__Pyx_BufPtrFortranContig2d(double *, __pyx_pybuffernd_hh.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_hh.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_hh.diminfo[1].strides)) * __pyx_v_ej)));
 ...
 */
      ...
      for (__pyx_t_24 = 1; __pyx_t_24 < __pyx_t_19; __pyx_t_24+=1) {
 ...
 */
        ...
        __pyx_v_tmp = fabs(((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_h_a.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_h_a.diminfo[0].strides)) - ((*__Pyx_BufPtrFortranContig2d(double *, __pyx_pybuffernd_hh.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_hh.diminfo[0].strides, __pyx_t_27, __pyx_pybuffernd_hh.diminfo[1].strides)) * __pyx_v_ej)));
 ...
 *             eta = fmax(0, fmin(1, mu * gap[-1] / res ** 2))
 */
        __pyx_t_11 = ((__pyx_v_tmp > __pyx_v_res) != 0);
        if (__pyx_t_11) {
 ...
 *             alpha[i] *= 1-eta
 */
      if (__Pyx_PrintOne(0, __pyx_kp_s_steprule_3_to_be_done) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      break;
    }
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_28 * __pyx_v_alpha.strides[0]) )) *= (1.0 - __pyx_v_eta);
    }
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_19 * __pyx_v_alpha.strides[0]) )) += (__pyx_v_eta * __pyx_v_ej);
 ...
 *             h_a[i] *= (1 - eta)             # <<<<<<<<<<<<<<
 *             h_a[i] += hh[i, j] * (eta * ej)
 *         err_tr.push_back(np.mean(h_a <= 0))
 */
      __pyx_t_30 = __pyx_v_i;
      *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_h_a.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_h_a.diminfo[0].strides) *= (1.0 - __pyx_v_eta);
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_h_a.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_h_a.diminfo[0].strides) += ((*__Pyx_BufPtrFortranContig2d(double *, __pyx_pybuffernd_hh.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_hh.diminfo[0].strides, __pyx_t_32, __pyx_pybuffernd_hh.diminfo[1].strides)) * (__pyx_v_eta * __pyx_v_ej));
    }
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_mean); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyObject_RichCompare(((PyObject *)__pyx_v_h_a), __pyx_int_0, Py_LE); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __pyx_t_2 = 0;
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_34 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_34 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_v_err_tr.push_back(__pyx_t_34);
 ...
 *         if t % (max_iter/10) == 0:
 */
    __pyx_t_11 = (((__pyx_v_gap[-1]) < __pyx_v_epsi) != 0);
    if (__pyx_t_11) {
 ...
 * 
 */
    __pyx_t_11 = (((__pyx_v_t % (__pyx_v_max_iter / 10)) == 0) != 0);
    if (__pyx_t_11) {
 ...
 * 
 */
      __pyx_t_2 = __Pyx_PyInt_From_unsigned_int(__pyx_v_t); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      ...
      __Pyx_GIVEREF(__pyx_t_2);
      __pyx_t_2 = 0;
      __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)(&PyString_Type))), __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = PyNumber_Add(__pyx_kp_s_iter, __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = PyNumber_Add(__pyx_t_1, __pyx_kp_s_gap); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = PyFloat_FromDouble((__pyx_v_gap[-1])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      ...
      __Pyx_GIVEREF(__pyx_t_1);
      __pyx_t_1 = 0;
      __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)(&PyString_Type))), __pyx_t_3, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
static PyObject *__pyx_pw_3src_14frank_wolfe_cy_1fw_boost_cy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_hh,&__pyx_n_s_epsi,&__pyx_n_s_ratio,&__pyx_n_s_steprule,&__pyx_n_s_has_dcap,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_epsi)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fw_boost_cy", 1, 5, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ratio)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fw_boost_cy", 1, 5, 5, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_steprule)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fw_boost_cy", 1, 5, 5, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_has_dcap)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fw_boost_cy", 1, 5, 5, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "fw_boost_cy") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_epsi = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_epsi == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_ratio = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_ratio == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_steprule = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_steprule == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_has_dcap = __Pyx_PyObject_IsTrue(values[4]); if (unlikely((__pyx_v_has_dcap == (bool)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("fw_boost_cy", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("src.frank_wolfe_cy.fw_boost_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_hh), __pyx_ptype_5numpy_ndarray, 1, "hh", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_3src_14frank_wolfe_cy_fw_boost_cy(__pyx_self, __pyx_v_hh, __pyx_v_epsi, __pyx_v_ratio, __pyx_v_steprule, __pyx_v_has_dcap);
...
static PyObject *__pyx_pf_3src_14frank_wolfe_cy_fw_boost_cy(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_hh, double __pyx_v_epsi, double __pyx_v_ratio, int __pyx_v_steprule, bool __pyx_v_has_dcap) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_hh;
  __Pyx_Buffer __pyx_pybuffer_hh;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_t_1 = __pyx_f_3src_14frank_wolfe_cy_fw_boost_cy(__pyx_v_hh, __pyx_v_epsi, __pyx_v_ratio, __pyx_v_steprule, __pyx_v_has_dcap, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 * 
 * 
 * cdef double _primal_objective(np.ndarray[double, mode='c'] z, double mu):             # <<<<<<<<<<<<<<
 *     """
 *     mu * log(1/n * sum(-z_i/mu))
 */

static double __pyx_f_3src_14frank_wolfe_cy__primal_objective(PyArrayObject *__pyx_v_z, double __pyx_v_mu) {
  double __pyx_v_res;
  unsigned int __pyx_v_i;
  unsigned int __pyx_v_n;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_primal_objective", 0);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_z.rcbuffer->pybuffer, (PyObject*)__pyx_v_z, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
    ...
    __pyx_t_5 = (-(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_z.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_z.diminfo[0].strides)));
 ...
 */
  ...
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_WriteUnraisable("src.frank_wolfe_cy._primal_objective", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_z.rcbuffer->pybuffer);
...
static double __pyx_f_3src_14frank_wolfe_cy_k_average(PyArrayObject *__pyx_v_v, unsigned int __pyx_v_k) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("k_average", 0);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_v.rcbuffer->pybuffer, (PyObject*)__pyx_v_v, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 *     cdef double res = 0
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_v), __pyx_n_s_copy); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     cdef Py_ssize_t i
 */
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_qsort); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
    __pyx_t_3 = PyFloat_FromDouble(__pyx_v_res); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_u, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1); if (unlikely(__pyx_t_1 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = PyNumber_InPlaceAdd(__pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_6 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_6 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_WriteUnraisable("src.frank_wolfe_cy.k_average", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_v.rcbuffer->pybuffer);
 ...
 * @cython.boundscheck(False)
 * @cython.cdivision(True)
 * cdef void proj_cap_ent(np.ndarray[double, mode='c']d0, double v):             # <<<<<<<<<<<<<<
 *     """
 *     projection with the entropy distance, with capped distribution
 */

static void __pyx_f_3src_14frank_wolfe_cy_proj_cap_ent(PyArrayObject *__pyx_v_d0, double __pyx_v_v) {
  PyObject *__pyx_v_u = NULL;
  int __pyx_v_m;
  double __pyx_v_z;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("proj_cap_ent", 0);
  __pyx_pybuffer_d0.pybuffer.buf = NULL;
  __pyx_pybuffer_d0.refcount = 0;
  __pyx_pybuffernd_d0.data = NULL;
  __pyx_pybuffernd_d0.rcbuffer = &__pyx_pybuffer_d0;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_d0.rcbuffer->pybuffer, (PyObject*)__pyx_v_d0, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 *     if v < 1.0 / m:
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_d0), __pyx_n_s_copy); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 149; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     qsort(u)
 */
  __pyx_t_3 = ((__pyx_v_v < (1.0 / __pyx_v_m)) != 0);
  if (__pyx_t_3) {
 ...
 *     cdef double z = 0
 */
    if (__Pyx_PrintOne(0, __pyx_n_s_error) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 152; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    goto __pyx_L3;
  }
  __pyx_L3:;
 ...
 *     for i in range(m):
 */
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_qsort); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 153; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     for i in range(m):
 */
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_m); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  if (PyList_CheckExact(__pyx_t_4) || PyTuple_CheckExact(__pyx_t_4)) {
    ...
    __pyx_t_5 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_t_4); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
  ...
  for (;;) {
    if (!__pyx_t_6 && PyList_CheckExact(__pyx_t_1)) {
      ...
      #if CYTHON_COMPILING_IN_CPYTHON
      __pyx_t_4 = PyList_GET_ITEM(__pyx_t_1, __pyx_t_5); __Pyx_INCREF(__pyx_t_4); __pyx_t_5++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #else
      __pyx_t_4 = PySequence_ITEM(__pyx_t_1, __pyx_t_5); __pyx_t_5++; if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #endif
    } else if (!__pyx_t_6 && PyTuple_CheckExact(__pyx_t_1)) {
      if (__pyx_t_5 >= PyTuple_GET_SIZE(__pyx_t_1)) break;
      #if CYTHON_COMPILING_IN_CPYTHON
      __pyx_t_4 = PyTuple_GET_ITEM(__pyx_t_1, __pyx_t_5); __Pyx_INCREF(__pyx_t_4); __pyx_t_5++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #else
      __pyx_t_4 = PySequence_ITEM(__pyx_t_1, __pyx_t_5); __pyx_t_5++; if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #endif
    } else {
 ...
 *         e = (1 - v * i) / z
 */
    __pyx_t_4 = PyFloat_FromDouble(__pyx_v_z); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 156; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = PyObject_GetItem(__pyx_v_u, __pyx_v_i); if (unlikely(__pyx_t_2 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 156; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_7 = PyNumber_InPlaceAdd(__pyx_t_4, __pyx_t_2); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 156; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_7); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 156; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         if e * u[i] <= v:
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_m); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_7, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  if (PyList_CheckExact(__pyx_t_1) || PyTuple_CheckExact(__pyx_t_1)) {
    ...
    __pyx_t_5 = -1; __pyx_t_7 = PyObject_GetIter(__pyx_t_1); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
  ...
  for (;;) {
    if (!__pyx_t_6 && PyList_CheckExact(__pyx_t_7)) {
      ...
      #if CYTHON_COMPILING_IN_CPYTHON
      __pyx_t_1 = PyList_GET_ITEM(__pyx_t_7, __pyx_t_5); __Pyx_INCREF(__pyx_t_1); __pyx_t_5++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #else
      __pyx_t_1 = PySequence_ITEM(__pyx_t_7, __pyx_t_5); __pyx_t_5++; if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #endif
    } else if (!__pyx_t_6 && PyTuple_CheckExact(__pyx_t_7)) {
      if (__pyx_t_5 >= PyTuple_GET_SIZE(__pyx_t_7)) break;
      #if CYTHON_COMPILING_IN_CPYTHON
      __pyx_t_1 = PyTuple_GET_ITEM(__pyx_t_7, __pyx_t_5); __Pyx_INCREF(__pyx_t_1); __pyx_t_5++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #else
      __pyx_t_1 = PySequence_ITEM(__pyx_t_7, __pyx_t_5); __pyx_t_5++; if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #endif
    } else {
 ...
 *             break
 */
    __pyx_t_1 = PyFloat_FromDouble(__pyx_v_v); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 158; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = PyNumber_Multiply(__pyx_t_1, __pyx_v_i); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 158; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = PyNumber_Subtract(__pyx_int_1, __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 158; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyFloat_FromDouble(__pyx_v_z); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 158; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_4 = __Pyx_PyNumber_Divide(__pyx_t_1, __pyx_t_2); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 158; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *         z -= u[i]
 */
    __pyx_t_4 = PyObject_GetItem(__pyx_v_u, __pyx_v_i); if (unlikely(__pyx_t_4 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 159; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = PyNumber_Multiply(__pyx_v_e, __pyx_t_4); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 159; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyFloat_FromDouble(__pyx_v_v); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 159; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_1 = PyObject_RichCompare(__pyx_t_2, __pyx_t_4, Py_LE); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 159; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 *         d0[i] = fmin(v, e *d0[i])
 */
    __pyx_t_1 = PyFloat_FromDouble(__pyx_v_z); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 161; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_4 = PyObject_GetItem(__pyx_v_u, __pyx_v_i); if (unlikely(__pyx_t_4 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 161; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = PyNumber_InPlaceSubtract(__pyx_t_1, __pyx_t_4); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 161; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 161; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_v_z = __pyx_t_8;
  }
  __pyx_L7_break:;
 ...
 *     # d = np.minimum(v, e * d0)
 */
  __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_m); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  ...
  __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_2, NULL); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyList_CheckExact(__pyx_t_7) || PyTuple_CheckExact(__pyx_t_7)) {
    ...
    __pyx_t_5 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_t_7); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
  ...
  for (;;) {
    if (!__pyx_t_6 && PyList_CheckExact(__pyx_t_2)) {
      ...
      #if CYTHON_COMPILING_IN_CPYTHON
      __pyx_t_7 = PyList_GET_ITEM(__pyx_t_2, __pyx_t_5); __Pyx_INCREF(__pyx_t_7); __pyx_t_5++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #else
      __pyx_t_7 = PySequence_ITEM(__pyx_t_2, __pyx_t_5); __pyx_t_5++; if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #endif
    } else if (!__pyx_t_6 && PyTuple_CheckExact(__pyx_t_2)) {
      if (__pyx_t_5 >= PyTuple_GET_SIZE(__pyx_t_2)) break;
      #if CYTHON_COMPILING_IN_CPYTHON
      __pyx_t_7 = PyTuple_GET_ITEM(__pyx_t_2, __pyx_t_5); __Pyx_INCREF(__pyx_t_7); __pyx_t_5++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #else
      __pyx_t_7 = PySequence_ITEM(__pyx_t_2, __pyx_t_5); __pyx_t_5++; if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      #endif
    } else {
 ...
 * 
 */
    if (unlikely(!__pyx_v_e)) { __Pyx_RaiseUnboundLocalError("e"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
    __pyx_t_7 = PyObject_GetItem(((PyObject *)__pyx_v_d0), __pyx_v_i); if (unlikely(__pyx_t_7 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_4 = PyNumber_Multiply(__pyx_v_e, __pyx_t_7); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    ...
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyFloat_FromDouble(fmin(__pyx_v_v, __pyx_t_8)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_d0), __pyx_v_i, __pyx_t_4) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  }
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_d0.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_WriteUnraisable("src.frank_wolfe_cy.proj_cap_ent", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_d0.rcbuffer->pybuffer);
  __pyx_L2:;
...
static void __pyx_f_3src_14frank_wolfe_cy_exp_descent(PyArrayObject *__pyx_v_v, PyArrayObject *__pyx_v_x0, PyArrayObject *__pyx_v_x, double __pyx_v_sigma, struct __pyx_opt_args_3src_14frank_wolfe_cy_exp_descent *__pyx_optional_args) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_v.rcbuffer->pybuffer, (PyObject*)__pyx_v_v, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_v.diminfo[0].strides = __pyx_pybuffernd_v.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_v.diminfo[0].shape = __pyx_pybuffernd_v.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x0.rcbuffer->pybuffer, (PyObject*)__pyx_v_x0, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x.rcbuffer->pybuffer, (PyObject*)__pyx_v_x, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 *             x[i] = x0[i] - sigma * v[i]
 */
  __pyx_t_1 = PyObject_RichCompare(__pyx_v_dist_option, __pyx_int_1, Py_EQ); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 181; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_x.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_x.diminfo[0].strides) = ((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_x0.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_x0.diminfo[0].strides)) - (__pyx_v_sigma * (*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_v.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_v.diminfo[0].strides))));
    }
    goto __pyx_L3;
  }
 ...
 *     elif dist_option == 2:             # <<<<<<<<<<<<<<
 *         for i in xrange(n):
 *             x[i] = x0[i] * map.exp(-sigma * v[i])
 */
  __pyx_t_1 = PyObject_RichCompare(__pyx_v_dist_option, __pyx_int_2, Py_EQ); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 184; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
      __pyx_t_8 = __pyx_v_i;
      if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_pybuffernd_x0.diminfo[0].shape;
      __pyx_t_1 = PyFloat_FromDouble((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_x0.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_x0.diminfo[0].strides))); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_builtin_map, __pyx_n_s_exp); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_10 = __pyx_v_i;
      if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_pybuffernd_v.diminfo[0].shape;
      __pyx_t_11 = PyFloat_FromDouble(((-__pyx_v_sigma) * (*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_v.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_v.diminfo[0].strides)))); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_11 = 0;
      __pyx_t_11 = __Pyx_PyObject_Call(__pyx_t_9, __pyx_t_12, NULL); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_11);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __pyx_t_12 = PyNumber_Multiply(__pyx_t_1, __pyx_t_11); if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_12);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_t_13 = __pyx_PyFloat_AsDouble(__pyx_t_12); if (unlikely((__pyx_t_13 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __pyx_t_14 = __pyx_v_i;
      if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_pybuffernd_x.diminfo[0].shape;
      *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_x.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_x.diminfo[0].strides) = __pyx_t_13;
 ...
 */
      ...
      __pyx_v_s = (__pyx_v_s + (*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_x.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_x.diminfo[0].strides)));
    }
 ...
 */
      ...
      *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_x.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_x.diminfo[0].strides) /= __pyx_v_s;
    }
    goto __pyx_L3;
  }
  __pyx_L3:;
 ...
 * @cython.boundscheck(False)
 * @cython.cdivision(True)
 * cdef void mat_vec(np.ndarray[double, ndim=2]aa,             # <<<<<<<<<<<<<<
 *                   np.ndarray[double, mode='c']b, np.ndarray[double,mode='c'] c):
 *     """
 */

static void __pyx_f_3src_14frank_wolfe_cy_mat_vec(PyArrayObject *__pyx_v_aa, PyArrayObject *__pyx_v_b, PyArrayObject *__pyx_v_c) {
  Py_ssize_t __pyx_v_n;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_aa.rcbuffer->pybuffer, (PyObject*)__pyx_v_aa, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 194; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_b.rcbuffer->pybuffer, (PyObject*)__pyx_v_b, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 194; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_c.rcbuffer->pybuffer, (PyObject*)__pyx_v_c, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 194; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  #ifndef CYTHON_WITHOUT_ASSERTIONS
  if (unlikely(!Py_OptimizeFlag)) {
    if (unlikely(!(((__pyx_v_c->dimensions[0]) == __pyx_v_n) != 0))) {
      PyErr_SetNone(PyExc_AssertionError);
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    if (__pyx_t_3 < 0) __pyx_t_3 += __pyx_pybuffernd_c.diminfo[0].shape;
    *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_c.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_c.diminfo[0].strides) = 0.0;
  }
 ...
 */
      ...
      __pyx_t_9 = __pyx_v_i;
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_pybuffernd_c.diminfo[0].shape;
      *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_c.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_c.diminfo[0].strides) += ((*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_aa.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_aa.diminfo[0].strides, __pyx_t_7, __pyx_pybuffernd_aa.diminfo[1].strides)) * (*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_b.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_b.diminfo[0].strides)));
    }
  }
 ...
 *                   np.ndarray[double, ndim=2, mode='fortran']bb, np.ndarray[double, mode='c']c):
 *     # not most efficient!!!!!!!!!
 */

static void __pyx_f_3src_14frank_wolfe_cy_vec_mat(PyArrayObject *__pyx_v_a, PyArrayObject *__pyx_v_bb, PyArrayObject *__pyx_v_c) {
  Py_ssize_t __pyx_v_n;
  Py_ssize_t __pyx_v_m;
  Py_ssize_t __pyx_v_j;
  Py_ssize_t __pyx_v_i;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_a.rcbuffer->pybuffer, (PyObject*)__pyx_v_a, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 211; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_bb.rcbuffer->pybuffer, (PyObject*)__pyx_v_bb, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_F_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 211; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_c.rcbuffer->pybuffer, (PyObject*)__pyx_v_c, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 211; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_c.diminfo[0].strides = __pyx_pybuffernd_c.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_c.diminfo[0].shape = __pyx_pybuffernd_c.rcbuffer->pybuffer.shape[0];
 ...
 */
  #ifndef CYTHON_WITHOUT_ASSERTIONS
  if (unlikely(!Py_OptimizeFlag)) {
    if (unlikely(!(((__pyx_v_c->dimensions[0]) == __pyx_v_m) != 0))) {
      PyErr_SetNone(PyExc_AssertionError);
 ...
 */
      ...
      __pyx_t_9 = __pyx_v_j;
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_pybuffernd_c.diminfo[0].shape;
      *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_c.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_c.diminfo[0].strides) += ((*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_a.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_a.diminfo[0].strides)) * (*__Pyx_BufPtrFortranContig2d(double *, __pyx_pybuffernd_bb.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_bb.diminfo[0].strides, __pyx_t_8, __pyx_pybuffernd_bb.diminfo[1].strides)));
    }
  }
 ...
 * 
 * 
 * cdef double l1norm(np.ndarray[double, mode='c'] v):             # <<<<<<<<<<<<<<
 *     cdef unsigned int n = v.shape[0]
 *     cdef unsigned int i
 */

static double __pyx_f_3src_14frank_wolfe_cy_l1norm(PyArrayObject *__pyx_v_v) {
  unsigned int __pyx_v_n;
  unsigned int __pyx_v_i;
  double __pyx_v_res;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_v;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_v.rcbuffer->pybuffer, (PyObject*)__pyx_v_v, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 227; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_v.diminfo[0].strides = __pyx_pybuffernd_v.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_v.diminfo[0].shape = __pyx_pybuffernd_v.rcbuffer->pybuffer.shape[0];
 ...
 */
    ...
    __pyx_v_res = (__pyx_v_res + fabs((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_v.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_v.diminfo[0].strides))));
  }
 ...
 *     return res             # <<<<<<<<<<<<<<
 * 
 * cdef double smallest(np.ndarray[double, mode='c'] u):
 */
  __pyx_r = __pyx_v_res;
  goto __pyx_L0;
...
static double __pyx_f_3src_14frank_wolfe_cy_smallest(PyArrayObject *__pyx_v_u) {
  unsigned int __pyx_v_n;
  Py_ssize_t __pyx_v_i;
  double __pyx_v_res;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_u.rcbuffer->pybuffer, (PyObject*)__pyx_v_u, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 235; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  __pyx_v_res = (*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_u.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_u.diminfo[0].strides));
 ...
 */
    ...
    } else if (unlikely(__pyx_t_5 >= __pyx_pybuffernd_u.diminfo[0].shape)) __pyx_t_2 = 0;
    if (unlikely(__pyx_t_2 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_2);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 240; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_t_6 = (((*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_u.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_u.diminfo[0].strides)) < __pyx_v_res) != 0);
    if (__pyx_t_6) {
 ...
 */
      ...
      } else if (unlikely(__pyx_t_7 >= __pyx_pybuffernd_u.diminfo[0].shape)) __pyx_t_2 = 0;
      if (unlikely(__pyx_t_2 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_2);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 241; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_res = (*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_u.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_u.diminfo[0].strides));
      goto __pyx_L5;
    }
    __pyx_L5:;
  }
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  __Pyx_NAMESTR("src.frank_wolfe_cy.array"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("src.frank_wolfe_cy.Enum"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("src.frank_wolfe_cy.memoryview"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("src.frank_wolfe_cy._memoryviewslice"), /*tp_name*/
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  #endif
  __pyx_builtin_map = __Pyx_GetBuiltinName(__pyx_n_s_map); if (!__pyx_builtin_map) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "src.frank_wolfe_cy")) {
      if (unlikely(PyDict_SetItemString(modules, "src.frank_wolfe_cy", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  /* "src/frank_wolfe_cy.pyx":15
 * # from aux.quicksort import sort as qsort
 * # import ksmall as ksm
 * from quicksort import sort as qsort             # <<<<<<<<<<<<<<
 * 
 * ctypedef np.float_t dtype_t
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_quicksort, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_sort); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_qsort, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
